...
Getting Started 
---------------
First, read the installation guide in the reference docs linked below. A good way to learn about the features of the library is to look at the source code, in particular :doc:`csarray` which is the sparse matrix class. More complete documentation is forthcoming, but for now here are some examples
